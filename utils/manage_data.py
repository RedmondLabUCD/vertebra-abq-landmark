...
def create_mask(image_name,xy_pairs,vertebra):
    ...
    plt.scatter(points[6,0],points[6,1],color='r', marker='o', s=0.5)
    plt.scatter(points[65:72,0],points[65:72,1],color='r', marker='o', s=0.5)
    plt.scatter(points[37:49,0],points[37:49,1],color='r', marker='o', s=0.5)

    plt.scatter(points[1,0],points[1,1],color='b', marker='o', s=0.5)
    plt.scatter(points[3,0],points[3,1],color='b', marker='o', s=0.5)
    plt.scatter(points[5,0],points[5,1],color='b', marker='o', s=0.5)
    plt.scatter(points[7,0],points[7,1],color='b', marker='o', s=0.5)
    plt.scatter(points[72:87,0],points[72:87,1],color='b', marker='o', s=0.5)
    plt.scatter(points[30:37,0],points[30:37,1],color='b', marker='o', s=0.5)

    plt.scatter(points[8,0],points[8,1],color='g', marker='o', s=0.5)
    plt.scatter(points[9,0],points[9,1],color='g', marker='o', s=0.5)
    plt.scatter(points[10,0],points[10,1],color='g', marker='o', s=0.5)
    plt.scatter(points[11,0],points[11,1],color='g', marker='o', s=0.5)
    plt.scatter(points[23:30,0],points[23:30,1],color='g', marker='o', s=0.5)
    plt.scatter(points[58:65,0],points[58:65,1],color='g', marker='o', s=0.5)

    plt.scatter(points[12:23,0],points[12:23,1],color='m', marker='o', s=0.5)
    plt.scatter(points[49:58,0],points[49:58,1],color='m', marker='o', s=0.5)
