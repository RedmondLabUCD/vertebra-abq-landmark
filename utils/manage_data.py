...
def create_mask(image_name,xy_pairs,vertebra):
    ...
    img_cropped = pixel_array[(int(points[0,1])-100):(int(points[4,1])+100), (int(points[4,0])-100):(int(points[0,0])+100)]

    points[:,0] = points[:,0]-(int(points[4,0])-100)
    points[:,1] = points[:,1]-(int(points[0,1])-100)
    ...
    plt.scatter(points[72:87,0],points[72:87,1],color='r', marker='o', s=1)
    ...
    plt.scatter(points[58:65,0],points[58:65,1],color='b', marker='o', s=1)
    plt.scatter(points[30:37,0],points[30:37,1],color='b', marker='o', s=1)

    plt.scatter(points[2,0],points[2,1],color='c', marker='o', s=1)
    plt.scatter(points[8,0],points[8,1],color='c', marker='o', s=1)
    plt.scatter(points[9,0],points[9,1],color='c', marker='o', s=1)
    plt.scatter(points[10,0],points[10,1],color='c', marker='o', s=1)
    plt.scatter(points[11,0],points[11,1],color='c', marker='o', s=1)
    plt.scatter(points[65:72,0],points[65:72,1],color='c', marker='o', s=1)
    plt.scatter(points[23:30,0],points[23:30,1],color='c', marker='o', s=1)
